...
async def root_dashboard():
    ...
    <html>
        <head>
            <title>QuantCode Nexus | B2B Lead Ingestor</title>
            <style>
                ...
                .badge { display: inline-block; background: #22c55e; color: white; padding: 4px 12px; border-radius: 20px; font-size: 14px; font-weight: bold; }
                .endpoints { margin-top: 20px; background: #0f172a; padding: 15px; border-radius: 8px; }
        ...
        <body>
            <div class="container">
                <h1>QuantCode Nexus</h1>
                <p>Enterprise B2B Lead Ingestion & Autonomous AI Pipeline</p>
                <p><span class="badge">SYSTEM ONLINE</span></p>
                <div class="endpoints">
                    <h3>Quick Links:</h3>
                    <ul>
                        <li><a href="/api/v1/leads" target="_blank">View Ingested Leads (JSON)</a></li>
                        <li><a href="/docs" target="_blank">Interactive API Docs (Swagger UI)</a></li>
